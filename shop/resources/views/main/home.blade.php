...
@section('content')
                        ...
                        <div class="block1 wrap-pic-w">
                            ...
                            class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
                                <div class="block1-txt-child1 flex-col-l">
                                    <span class="block1-name ltext-110 trans-04 p-b-8">
                                        {{ $menu->name }}
                                    </span>

                                    <span class="block1-info stext-115 trans-04">
                                        Latest 2023
                                    </span>
                                </div>
    ...
    <section class="bg0 p-t-23 p-b-140">
        <div class="container">
            ...
            <div id="loadProduct">
                @include('main.products-list')
            </div>

            <!-- Load more -->
            <div class="flex-sa-m flex-w w-full p-t-45" id="btn-loadmore">
                <input type="hidden" value="1" id="page">
                <a class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04 pointer" onclick="loadmore()">
                    Load More
                </a>
            </div>
        </div>
